...
typedef void (^AFURLConnectionClosedBlock)(void);
...
/**
A Boolean value that indicates if the connection was cancelled
*/
@property (atomic, assign) BOOL wasCancelled;

/**
 A Boolean value that indicates if the connection was paused
 */
@property (atomic, assign) BOOL wasPaused;
...
/**
 Block called to notify the UI when the connection was closed. 
 */
@property (nonatomic, copy) AFURLConnectionClosedBlock connectionClosed;
///----------------------------------
